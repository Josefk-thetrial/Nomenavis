...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CmE3-MGF.js
var router_CmE3_MGF_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-Dqg6xDmv.css";
var APP_NAME = "Nomenavis";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Digite o nome de uma personalidade histórica e destrua a nave. Atirador de digitação com recorde."
			},
			{
				name: "theme-color",
				content: "#08090c"
...
var $$splitComponentImporter = () => import("./routes-gFb0jaPo.mjs");
...
//#endregion
export { getRouter, router_CmE3_MGF_exports as t };
